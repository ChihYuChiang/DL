...
from grammar import *
from qa import *
from c5_1_preprocess import * 
from c5_1_music_utils import *
from c5_1_data_utils import *
...
#Keras layer objects as global variables
...
def music_inference_model(LSTM_cell, densor, n_values = 78, n_a = 64, Ty = 100):
    ...
    #1Define the input of your model with a shape 
    ...
    for t in range(Ty):
        ...
        #Step 2.D: Select the next value according to "out", and set "x" to be the one-hot representation of the selected value, which will be passed as the input to LSTM_cell on the next step. We have provided the line of code you need to do this. 
...
#Initialize values for inference model
x_initializer = np.zeros((1, 1, 78))
a_initializer = np.zeros((1, n_a))
c_initializer = np.zeros((1, n_a))


#--Sample music from the inference model
