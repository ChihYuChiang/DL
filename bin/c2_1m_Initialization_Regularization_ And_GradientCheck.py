...
def model(X, Y, learning_rate=0.3, num_iterations=30000, print_cost=True, lambd=0, keep_prob=1):
    ...
    for i in range(0, num_iterations):
        ...
        assert(lambd==0 or keep_prob==1)    #it is possible to use both L2 regularization and dropout, but this assignment will only explore one at a time
...
def initialize_parameters_he(layers_dims):
    """
    He Initialization (He et al., 2015), best for ReLu
